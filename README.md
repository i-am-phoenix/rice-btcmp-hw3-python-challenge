...
Results of the analysis are output to both standard gitBash output as well as within the output file [Resources/election_data_analysis.txt](election_data_analysis.txt).
